...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FrameView = __webpack_require__(221);

	var _FrameView2 = _interopRequireDefault(_FrameView);

	var _Landing = __webpack_require__(231);

	var _Landing2 = _interopRequireDefault(_Landing);

	var _CommentBox = __webpack_require__(255);
	...
	var ReactDOM = __webpack_require__(237);
	var People = __webpack_require__(238);

	var App = function App() {
	  return React.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory }, React.createElement(_reactRouter.Route, { path: '/', component: _FrameView2.default }, React.createElement(_reactRouter.IndexRoute, { component: _Landing2.default }), React.createElement(_reactRouter.Route, { path: '/people', component: People }), React.createElement(_reactRouter.Route, { path: '/commentbox', component: _CommentBox2.default })));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FrameView = function (_Component) {
	  _inherits(FrameView, _Component);

	  function FrameView(props) {
	    _classCallCheck(this, FrameView);

	    return _possibleConstructorReturn(this, (FrameView.__proto__ || Object.getPrototypeOf(FrameView)).call(this, props));
	  }
	  ...
	  _createClass(FrameView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { className: 'frameView' }, _react2.default.createElement(_Nav2.default, null), this.props.children);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./FrameView.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./FrameView.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = function (_Component) {
	  ...
	  _createClass(Nav, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('nav', { id: 'navContainer' }, _react2.default.createElement(_reactRouter.Link, { to: '/' }, _react2.default.createElement('h1', null, 'Phillip Emerson Jones')), _react2.default.createElement('ul', null, _react2.default.createElement('li', null, 'About'), _react2.default.createElement('li', null, 'Contact'), _react2.default.createElement(_reactRouter.Link, { to: '/commentbox' }, _react2.default.createElement('li', null, 'Comments')), _react2.default.createElement(_reactRouter.Link, { to: '/people' }, _react2.default.createElement('li', null, 'People'))), _react2.default.createElement('img', { src: 'public/window.svg' }));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MyTitle = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Landing.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Landing.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MyTitle = __webpack_require__(235);
	...
	var MyTitle = function (_Component) {
	  ...
	  function MyTitle(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (MyTitle.__proto__ || Object.getPrototypeOf(MyTitle)).call(this, props));

	    _this.state = {
	      fruit: ['apple', 'grapes']
	    };
	    _this.changeFruit = _this.changeFruit.bind(_this);
	    return _this;
	  }

	  _createClass(MyTitle, [{
	    key: 'changeFruit',
	    value: function changeFruit() {
	      var _this2 = this;

	      var newFruit = document.getElementById('fruitInput');
	      console.log(_react2.default.PropTypes);
	      if (newFruit.value !== '') {
	        (function () {
	          var addFruit = newFruit.value;
	          newFruit.value = '';
	          _this2.setState(function () {
	            return _this2.state.fruit.push(addFruit);
	          });
	        })();
	      }
	    }
	    ...
	    value: function render() {
	      var style = { color: this.props.color };
	      return _react2.default.createElement('div', { className: 'myTitle' }, _react2.default.createElement('h1', { style: style }, this.props.title), _react2.default.createElement('input', { id: 'fruitInput', placeholder: 'add fruit' }), _react2.default.createElement('button', { onClick: this.changeFruit }, 'add Fruit'), _react2.default.createElement('ul', null, this.state.fruit.map(function (a) {
	        return _react2.default.createElement('li', { key: a }, a);
	      })), _react2.default.createElement('p', null, this.props.happy));
	    }
	  }]);
	...
	MyTitle.propTypes = {
	  happy: _react2.default.PropTypes.string,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./MyTitle.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./MyTitle.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".myTitle input {\n  border: 1px solid #000;\n  border-radius: 14px;\n  padding: 10px;\n}\n.myTitle ul {\n  list-style: none;\n}\n.myTitle button {\n  margin-left: 10px;\n  background: #cd853f;\n  padding: 10px;\n  border-radius: 14px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./People.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./People.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentForm.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentForm.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentList.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentList.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".commentList {\n  margin-top: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentList = __webpack_require__(249);

	var _CommentList2 = _interopRequireDefault(_CommentList);

	var _CommentForm = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentBox.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./CommentBox.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Comment.styl", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/stylus-loader/index.js!./Comment.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
